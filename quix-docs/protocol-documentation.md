...
| Field Size | Field Name | Data type | Description |
| ---------- | ----------- | --------- | -------- |
| 41 | vin | CTxIn | The unspent output which is holding 1000 QUIX
| # | addr | CService | Address of the main 1000 QUIX unspent output
| 33-65 | pubKeyCollateralAddress | CPubKey | CPubKey of the main 1000 QUIX unspent output
