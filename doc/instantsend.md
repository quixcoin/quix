...
This mechanism has been integrated into Bitcore-Node-QUIX which allows for notification to be broadcast through Insight API in one of two ways:
* WebSocket: [https://github.com/quixcoin/insight-api-quix#web-socket-api](https://github.com/quixcoin/insight-api-quix#web-socket-api) 
* API: [https://github.com/quixcoin/insight-api-quix#instantsend-transactions](https://github.com/quixcoin/insight-api-quix#instantsend-transactions) 
...
By default, the QUIX Core daemon will launch using the following constant:

```
static const int DEFAULT_INSTANTSEND_DEPTH = 5;
```

This value can be overridden by passing the following argument to the QUIX Core daemon:
