...
Only requiring some minor changes is quix.cpp.
...
Changes to quix.cpp
----------------------
quix.cpp is the entry point into bitcoin-qt, and as such, will require some minor modifications to provide hooks for
