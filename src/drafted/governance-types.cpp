...
GovernanceObjectType GovernanceStringToType(std::string strType) {
    ...
    if(strType == "QUIXNetwork") type = QUIXNetwork;
    if(strType == "QUIXNetworkVariable") type = QUIXNetworkVariable;
...
std::string GovernanceTypeToString(GovernanceObjectType type) {
    ...
    if(type == QUIXNetwork) s = "QUIXNetwork";
    if(type == QUIXNetworkVariable) s = "QUIXNetworkVariable";
