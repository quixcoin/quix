 ...
 *
 *   // network
 *   CQUIXNetwork lvl, network-type, network-status, network-error, milestone-status*
...
private:
    ...
    // Current OBJECT STATUS (see http://govman.quix.org/index.php/Documentation_:_Status_Field)
    int nStatusID;
...
// // root node
class CQUIXNetwork : public CGovernanceObject
{
private:
    std::string strName;
    std::string strURL;
...
// // can be under: QUIXNetwork
// //   -- signature requirements : Key1(User)
// class CQUIXNetworkVariable : public CGovernanceObject
// {
// private:
