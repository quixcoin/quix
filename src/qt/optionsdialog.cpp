    ...
    mapper(0)
{
    ...
    /* Theme selector */
    ui->theme->addItem(QString("QUIX-light"), QVariant("light"));
    ui->theme->addItem(QString("QUIX-blue"), QVariant("drkblue"));
    ui->theme->addItem(QString("QUIX-Crownium"), QVariant("crownium"));
    ui->theme->addItem(QString("QUIX-traditional"), QVariant("trad"));
