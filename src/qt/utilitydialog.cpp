    ...
    ui(new Ui::HelpMessageDialog)
{
    ...
    QString version = tr("QUIX Core") + " " + tr("version") + " " + QString::fromStdString(FormatFullVersion());
    ...
    if (helpMode == about)
    {
        setWindowTitle(tr("About QUIX Core"));
        ...
        QString header = tr("Usage:") + "\n" +
            "  quix-qt [" + tr("command-line options") + "]                     " + "\n";
...
All the QUIX in your wallet is comprised of different \"inputs\" which you can think of as separate, discrete coins.<br> \
...
These denominations are 0.01 QUIX, 0.1 QUIX, 1 QUIX and 10 QUIX -- sort of like the paper money you use every day.</li> \
...
For more info see <a href=\"https://quixcoin.atlassian.net/wiki/display/DOC/PrivateSend\">https://quixcoin.atlassian.net/wiki/display/DOC/PrivateSend</a> \
        "));
        ui->aboutMessage->setWordWrap(true);
        ui->helpMessage->setVisible(false);
        ui->aboutLogo->setVisible(false);
    ...
    QWidget(parent, f)
{
    ...
    layout->addWidget(new QLabel(
        tr("QUIX Core is shutting down...") + "<br /><br />" +
