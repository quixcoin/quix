    ...
    platformStyle(platformStyle)
{
    ...
    QString windowTitle = tr("QUIX Core") + " - ";
#ifdef ENABLE_WALLET
...
void BitcoinGUI::createActions()
{
    ...
    sendCoinsAction->setStatusTip(tr("Send coins to a QUIX address"));
    ...
    receiveCoinsAction->setStatusTip(tr("Request payments (generates QR codes and quix: URIs)"));
    ...
    aboutAction = new QAction(QIcon(":/icons/" + theme + "/about"), tr("&About QUIX Core"), this);
    aboutAction->setStatusTip(tr("Show information about QUIX Core"));
    ...
    optionsAction->setStatusTip(tr("Modify configuration options for QUIX Core"));
    ...
    signMessageAction->setStatusTip(tr("Sign messages with your QUIX addresses to prove you own them"));
    verifyMessageAction = new QAction(QIcon(":/icons/" + theme + "/transaction_0"), tr("&Verify message..."), this);
    verifyMessageAction->setStatusTip(tr("Verify messages to ensure they were signed with specified QUIX addresses"));
    ...
    openAction->setStatusTip(tr("Open a quix: URI or payment request"));

    showHelpMessageAction = new QAction(QApplication::style()->standardIcon(QStyle::SP_MessageBoxInformation), tr("&Command-line options"), this);
    showHelpMessageAction->setMenuRole(QAction::NoRole);
    showHelpMessageAction->setStatusTip(tr("Show the QUIX Core help message to get a list with possible QUIX Core command-line options"));
...
void BitcoinGUI::createTrayIcon(const NetworkStyle *networkStyle)
{
    ...
    QString toolTip = tr("QUIX Core client") + " " + networkStyle->getTitleAddText();
...
void BitcoinGUI::setNumConnections(int count)
{
    ...
    labelConnectionsIcon->setToolTip(tr("%n active connection(s) to QUIX network", "", count));
}
...
{
    QString strTitle = tr("QUIX Core"); // default title
